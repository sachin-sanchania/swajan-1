    ...
    <div class="owl-carousel owl-banner">
        <div class="item item-1">
            <div class="header-text">
                <h2>Hurry!<br>Luxurious Senior Care for you</h2>
            </div>
        </div>
        <div class="item item-2">
            <div class="header-text">
                <h2>Discover India's Foremost Senior Living Haven</h2>
            </div>
        </div>
        <div class="item item-3">
            <div class="header-text">
                <h2>Act Now!<br>Vibrant Cultural Programs</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="left-image">
                    <img src="{{asset('assets/images/old-age-feature.jpg')}}" alt="">
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="video-frame">
                    ...
                    <a href="https://www.youtube.com/watch?v=k5RkbNOx2ic" target="_blank"><i class="fa fa-play"></i></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="counter">
                                ...
                                <p class="count-text ">Lorem<br>Ipsum</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="counter">
...
<footer>
    <div class="container">
        <div class="col-lg-12">
            <p>Copyright © 2024 Swajan. All rights reserved.</p>
        </div>
    </div>
</footer>
